...
function Realisation() {
  return (
    <section className="realsection w-100 h-100 d-flex flex-column align-items-center justify-content-center justify-self-center">
      ...
      <div className="projet1 d-flex w-100 bg-white p-2 mx-auto my-2  ">
        <span>
          {" "}
      ...
      <div className="projet2 d-flex w-100 bg-white  ">
        <span>
          {" "}
