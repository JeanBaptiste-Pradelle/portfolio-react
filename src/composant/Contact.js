...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_t1k9u9h', 'template_p2hga0a', form.current, 'AeFSYwPhq_Z-OVwyn')
      .then(
        () => {
  ...
  return (
    <section id="contact" className='scontact w-100 h-100 d-flex flex-column align-items-center justify-content-center'>
      <div className='w-100'>
        
        <h1 className="mb-4 text-center mx-auto ">Le meilleur moyen de rester en contact</h1>
        ...
        <form ref={form} onSubmit={sendEmail} className="needs-validation" noValidate>
          ...
          <div className="mb-3 col-6 mx-auto text-center">
            ...
            <input type="email" name="user_email" className="form-control" id="user_email" required />
          </div>
          ...
          <div className="d-flex justify-content-center">
            <input type="submit" value="Envoyer" className="btn btn-primary me-2" />
